...
/**
  ...
  ******************************************************************************
  */
/* USER CODE END Header */                               // End of user-editable header section

/* Includes ------------------------------------------------------------------*/
#include "main.h"                                        // Main project header generated by STM32CubeIDE
...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
// Add your custom typedefs here if needed
/* USER CODE END PTD */

/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
// Add your custom #define constants here if needed
/* USER CODE END PD */

/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
// Add your custom macros here if needed
/* USER CODE END PM */

/* Private variables ---------------------------------------------------------*/
TIM_HandleTypeDef htim2;                                 // Handle for Timer 2 (used here for servo PWM)
TIM_HandleTypeDef htim3;                                 // Handle for Timer 3 (currently configured but not actively used in loop)
TIM_HandleTypeDef htim4;                                 // Handle for Timer 4 (currently configured for input capture)

UART_HandleTypeDef huart2;                               // Handle for USART2 serial communication

/* USER CODE BEGIN PV */
// Add private/global variables here if needed
/* USER CODE END PV */
...
static void MX_TIM2_Init(void);                          // Initializes Timer 2
static void MX_TIM3_Init(void);                          // Initializes Timer 3
static void MX_TIM4_Init(void);                          // Initializes Timer 4
/* USER CODE BEGIN PFP */
// Add extra function prototypes here if needed
/* USER CODE END PFP */
...
// Converts an angle into a pulse width that the servo understands.
...
int main(void)
{
  ...
  HAL_Init();                                           // Reset peripherals and initialize HAL library
  ...
  SystemClock_Config();                                 // Set up CPU/system clocks
...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = IR_in_1_Pin|IR_in_2_Pin|IR_in_3_Pin|IR_in_4_Pin
                          |IR_in_5_Pin|IR_in_6_Pin|IR_in_7_Pin|IR_in_8_Pin; // All IR sensor input pins
